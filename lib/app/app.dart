...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ListenableProvider<GetBrandProvider>(create: (_) => GetBrandProvider()),
        ...
        ListenableProvider<RequestProvider>(create: (_) => RequestProvider()),
        ListenableProvider<GetSuccessPartners>(
            create: (_) => GetSuccessPartners()),
        ListenableProvider<NotificationProvider>(
            create: (_) => NotificationProvider()),
        ListenableProvider<GetUserProvider>(create: (_) => GetUserProvider()),

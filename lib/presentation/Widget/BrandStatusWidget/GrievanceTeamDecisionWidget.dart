...
class GrievanceTeamDecisionWidget extends StatelessWidget {
  final BrandDetailsDataEntity brandDetailsDataEntity;
  final int number;

  const GrievanceTeamDecisionWidget(
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            children: [
                              ...
                              /// DATA OF GrievanceTeamDecisionWidget
                                  ...
                                  ? Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            "${data.dateOfTheCaseOfTheDecisionOfTheGrievanceCommittee}",
                                            style: displayLarge,
                                  ...
                                  ? Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            "${data.theDecisionOfTheApplicationToAcceptOrReject}",
                                            style: displayLarge,
                                            textAlign: TextAlign.start,
                                          ),
                                        ),
                              ...
                              checkNullValue(
                                      value: data.technicalOpinionDecision)
                                  ? Row(
                                      children: [
                                        Text(

...
class BrandDetailsDataModel extends BrandDetailsDataEntity {
  const BrandDetailsDataModel(
      ...
      required super.AllResult});

  factory BrandDetailsDataModel.fromJson(json) {
    List<ImagesModel> images = List<ImagesModel>.from((json["images"] as List)
    ...
    if (json["brand"]["cr"] != null) {
      List<ImagesModel> crImages = List<ImagesModel>.from(
          (jsonDecode(json["brand"]["cr"]) as List<dynamic>)
              .where((e) =>
                  e is Map<String, dynamic>) // Filter out any non-map elements
              .map((e) => ImagesModel.fromJson(e)));
    ...
    return BrandDetailsDataModel(
        ...
        AllResult: List<AllResultModel>.from(
            json["allResult"].map((e) => AllResultModel.fromJson(e))).toList(),
        images: images
...
class BrandDetailsModel extends BrandDetailsEntity {
  ...
  factory BrandDetailsModel.fromJson(Map<String, dynamic> json) {
    return BrandDetailsModel(
      ...
      completedPowerOfAttorneyRequest:
          json['completed_power_of_attorney_request'] ?? 0,
      importNumber: json['import_number'] ?? "",
      dateOfSupply: json['date_of_supply'] ?? "",
      tawkeelImage: json['date_of_supply_image'] == null
          ? ""
          : json['date_of_supply_image'].toString(),
      notes: json['notes'] ?? "",
      ...
      cr: json["cr"] != null
          ? List<ImagesModel>.from((jsonDecode(json["cr"]) as List<dynamic>)
              .map((e) => ImagesModel.fromJson(e)))
          : [],
      completedPowerOfAttorneyRequestImages:
          json["completed_power_of_attorney_request_images"] != null
              ? List<ImagesModel>.from(
                  (json["completed_power_of_attorney_request_images"])
                      .map((e) => ImagesModel.fromJson(e)))
              : [],
      completedPowerOfAttorneyRequestTypes:
          json["completed_power_of_attorney_request_images"] != null
...
class AllResultModel extends AllResult {
  ...
  factory AllResultModel.fromJson(
    ...
    return AllResultModel(
      ...
      acceptGallery: json["accept_images"] == null
          ? []
          : List<ImagesModel>.from(
              (json["accept_images"]).map((e) => ImagesModel.fromJson(e))),
      renovationsGallery: json["renovation_images"] == null
          ? []
          : List<ImagesModel>.from(
              (json["renovation_images"]).map((e) => ImagesModel.fromJson(e))),
      appealBrandRegistrationGallery: json["rejestration_images"] == null
          ? []
          : List<ImagesModel>.from((json["rejestration_images"])
              .map((e) => ImagesModel.fromJson(e))),
      appealGrivenceGallery: json["appeal_grivence_images"] == null
          ? []
          : List<ImagesModel>.from((json["appeal_grivence_images"])
              .map((e) => ImagesModel.fromJson(e))),
      conditionalAcceptanceGallery:
          json["conditional_acceptance_images"] == null
              ? []
              : List<ImagesModel>.from((json["conditional_acceptance_images"])
                  .map((e) => ImagesModel.fromJson(e))),
      refusedGallery: json["refused_images"] == null
          ? []
          : List<ImagesModel>.from(
              (json["refused_images"]).map((e) => ImagesModel.fromJson(e))),
      processingGallery: json["processing_images"] == null
          ? []
          : List<ImagesModel>.from(
              (json["processing_images"]).map((e) => ImagesModel.fromJson(e))),
      grievanceTeamDecisionGallery:
          json["grievance_team_decision_images"] == null
              ? []
              : List<ImagesModel>.from((json["grievance_team_decision_images"])
                  .map((e) => ImagesModel.fromJson(e))),
      grievanceGallery: json["grievance_images"] == null
          ? []
          : List<ImagesModel>.from(
              (json["grievance_images"]).map((e) => ImagesModel.fromJson(e))),
      giveUpGallery: json["giveup_images"] == null
          ? []
          : (List<ImagesModel>.from(
                      json["giveup_images"].map((e) => ImagesModel.fromJson(e)))
                  .toList()) ??
              [],
      ...
      publish_date_Gallery: json["publish_date_images"] == null
          ? []
          : List<ImagesModel>.from((json["publish_date_images"])
              .map((e) => ImagesModel.fromJson(e))),
      dateNotifyTheStudentOfOpposition:
          json["date_notify_the_student_of_opposition"] ?? "",
